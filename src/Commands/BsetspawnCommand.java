 ...
 */
public class BsetspawnCommand extends BuildUtils implements CommandExecutor
{
    Build main;

    public BsetspawnCommand(Build instance)
    {
        main = instance;
    }
...
//                p.sendMessage(color("&2Error - you do not have permission for this."));
            }else
            {
                ...
                p.sendMessage(color("&7Spawn has been &aset&7."));
                return true;
            }
        }
        return true;
